...
export const SKILLS: Record<SkillNames, Skill> = {
  ...
  [SkillNames.REACT]: {
    ...
    name: "react",
    label: "React",
    shortDescription: "use using use = useUsing('use')",
    color: "#61dafb",
  ...
  [SkillNames.BLENDER]: {
    ...
    name: "blender",
    label: "Blender",
    shortDescription: "3D creation magic! Modeling, sculpting, rendering, all-in-one 🌀🔥",
    color: "#f5792a",
  ...
  [SkillNames.LUA]: {
    ...
    name: "lua",
    label: "Lua Scripting",
    shortDescription: "lightweight scripting with big brain energy! 🐍⚡",
    color: "#000080",
  ...
  [SkillNames.SHELL]: {
    ...
    shortDescription: "Automating the boring stuff, one script at a time! 🐚💻",
    color: "#4EAA25",
  ...
  [SkillNames.PYTHON]: {
    ...
    name: "python",
    label: "Python",
    shortDescription: "Snakes on a codebase! Clean, readable, and powerful. 🐍🚀",
    color: "#3776AB",
